...
> "What do you think will happen to received power when a building blocks the direct path?"

Expected answer:

> Received power will generally decrease because the direct LOS path is blocked and the signal must rely on weaker reflected/diffracted paths.
...
> Change the transmitter frequency from 2.5 GHz to 3.5 GHz.

Then ask:

> "Do you expect the coverage area to increase or decrease?"

This encourages students to think about frequency-dependent propagation before they calculate anything.
...
**ss1\_concrete \= sigstrength(rx1,tx,rtpm);**
...
materialLoss \= ss1 \- ss1\_concrete;
...
**ss1\_weather \= sigstrength(rx1, tx, rtPlusWeather);**
...
**beamGainImprovement1 \= ...**  
    **ss1\_beam\_steering \- ss1\_weather;**
